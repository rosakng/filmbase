...
def _spectral_helper(x, y, fs=1.0, window='hann', nperseg=None, noverlap=None,
    ...
    This is a utils function that implements the commonality between
...
def _fft_helper(x, win, detrend_func, nperseg, noverlap, nfft, sides):
    ...
    This is a utils function that does the main FFT calculation for
    `_spectral utils`. All input validation is performed there, and the
...
def _triage_segments(window, nperseg, input_length):
    ...
    This is a utils function, not meant to be called externally.
